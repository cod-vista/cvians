...
export default function Home() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Cvians Excel Table v2.1.4</h1>
      ...
      <ExcelTable>
        <ExcelTableHeader>
          <ExcelTableRow>
            ...
            <ExcelTableHead filterable sortable dataType="boolean">Active</ExcelTableHead>
            <ExcelTableHead
              filterable
              sortable
              dataType="date"
        ...
        <ExcelTableBody>
          {sampleData.map((row) => (
            <ExcelTableRow key={row.id}>
              ...
              <ExcelTableCell>{row.active}</ExcelTableCell>
